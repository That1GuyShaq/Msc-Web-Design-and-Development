...
import { Formula, BackendPhaseIngredient } from '@/types/modules/formulation';
...
export default function CreateMethods({ auth, formula }: { auth: Auth, formula: Formula }) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Methods',
            href: '/formulation/formulas/' + formula.slug + '/methods/edit',
        },
        {
            title: 'Edit',
            href: '/formulation/formulas/' + formula.slug + '/methods/edit',
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="grid lg:grid-cols-6 gap-4">
                <MethodsForm tenant={auth.tenant.id} formula={formula} method={formula.method} />
