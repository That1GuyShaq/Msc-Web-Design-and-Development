        ...
        <div class="container-fluid d-flex justify-content-center align-items-center p-3">
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#studentModal" id="createStudent" data-bs-title="Create Student">
                        Create Student
                    </button>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?php echo $appUrl; ?>/App/Process/createStudent.php" method="post" class="row g-3 needs-validation" id="studentForm" novalidate>
