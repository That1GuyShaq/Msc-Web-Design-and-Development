...
- [shadcn/ui v2](https://ui.shadcn.com/docs)
...
> All tenant-scoped routes require authentication. Each path will be prefixed with your tenant domain (e.g. `https://{tenant}.appdomain.com…`).
